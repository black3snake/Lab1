...
namespace Lab1.UWP
{
    public sealed partial class MainPage
    {
        ...
        private void btCalculate_Click(object sender, RoutedEventArgs e)
        {
            ...
            int countEl = 0;
            //Brush br = null;
            SolidColorBrush br = new SolidColorBrush(Windows.UI.Colors.Salmon);
            SolidColorBrush brNull = null;
            foreach (Elements el in matrixList)
            {
                try
                {
                ...
                if (number > 0)
                {
                    ...
                    el.TextBoxRef.Background = brNull;
        ...
        {
            //consoleRight.Clear();
            consoleRight.Text = String.Empty;
        }
